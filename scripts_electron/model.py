...
Usage: python scripts/model.py <robot_name> <onshape_url>

Arguments:
    robot_name: Name of the robot (used for output directories and filenames)
    onshape_url: Full Onshape assembly URL
"""
...
def create_temp_config(document_id, workspace_id, version_id, element_id, output_dir, output_format, robot_name):
    """
...
def cleanup(robot_name):
    """
    Remove all files with .part extension in assets/
    """
    assets_dir = Path(__file__).parent.parent / "models" / robot_name / "assets"
...
def main():
    ...
    if len(sys.argv) < 3:
        ...
        print("Usage: python scripts/model.py <robot_name> <onshape_url>")
        print("\nArguments:")
        print("  robot_name  : Name of the robot (used for output directories and filenames)")
        print("  onshape_url : Full Onshape assembly URL")
        print("\nExample:")
        print("  python scripts/model.py gyro https://cad.onshape.com/documents/abc123/w/def456/e/ghi789")
        sys.exit(1)
    ...
    base_dir = Path(__file__).parent.parent / "models" / robot_name
